...
REPO_ROOT = _THIS_DIR.parents[2]  # project root: .../first_ai_automation
LOCATOR_REGISTRY = REPO_ROOT.joinpath("src", "pages", "locators.json")
SUGGEST_SCRIPT = REPO_ROOT.joinpath("scripts", "suggest_locator.py")
    ...
    def _dump_failure_snapshot(self, selector: str, out_path: Path):
        try:
            snap = {
                ...
                "page_html": self.page.content()[:200000]
            }
